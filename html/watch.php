...
<body>
    <div class="header" style="display: flex; justify-content: space-between; align-items: center; position: relative;">
        <a href="viewer.php" style="text-decoration: none;">
            ...
            <div class="video-wrapper">
                <div class="video-container">
                    ...
                    <div class="video-overlay">
                        <div class="status-badge"><div class="status-dot"></div><span>LIVE</span></div>
    ...
    <script>
        ...
        function toggleQuality() {
            console.log('Quality toggle - not implemented');
        }
